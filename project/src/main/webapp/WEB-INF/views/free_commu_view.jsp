		...
		<div class="row">
			<table class="table table-striped" style="text-align: center;">
				<thead>
					<tr>
						<th colspan="3"
							style="background-color: #eeeeee; text-align: center;">서울점
							노트북 재고 확인 부탁드려요.</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>작성자</td>
						<td colspan="2" style="min-height: 200px; text-align: left;">인천점(홍길동)</td>
					</tr>
					<tr>
						<td>작성일</td>
						<td colspan="2" style="min-height: 200px; text-align: left;">2018-10-09</td>
					</tr>
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left; font-size:18px">안녕하세요.
							인천점 입니다. 저희 주문건 등록한거 급하게 필요해서 확인좀 부탁드릴께요.</td>
					</tr>
				</tbody>
